...
public class Validation {
    ...
    public static void List_Jump_to_String(ComboBox box , String valeue){
     int size =  box.getItems().size();
      ...
      public static boolean Droped_Student(String Roll , int semester){
        try {
         String query = "select roll from droped_students where Roll = '"+Roll+"'  and Semester < '"+semester+"' ";
            ...
            System.out.println("Error in Marks Entry Class Function Already Droped "+e);
        }
        return false;
    }
   ...
   public static boolean Only_Text_Diaglog( JFXTextField field, int length , String name){
   ...
   public static boolean Only_Number_Diaglog( JFXTextField field, int length, String name){
   ...
   public static boolean Name_Diaglog(String text , JFXTextField field, int length , String name){
   ...
   public static boolean Only_Text_Color(  JFXTextField field, int length ){
   ...
   public static boolean Only_Number_Color( JFXTextField field, int length ){
...
//end of if statement   
   ...
   public static boolean Name_Color(JFXTextField field, int length  ){
    ...
    public static boolean Name_Diaglog_with_Dot(String text , JFXTextField field, int length , String name){
       if(text.length() > length){
         Alert alert = new Alert(AlertType.WARNING);
         alert.setTitle("Warning Dialog");
         alert.setContentText("You have done mistake! \n Max  "+length+" Character are allowed in "+name+" Field  ");
     ...
     public static boolean Name_Color_with_dot(JFXTextField field, int length  ){
       if(field.getText().length() > length){
          field.setStyle("-fx-text-inner-color:#ff0033;");
      }else if(!(field.getText().matches("[ a-zA-z]+([ '-./()][a-zA-Z() ]+)*"))){
         field.setStyle("-fx-text-inner-color:#ff0033;");
   ...
   public static boolean valid_Length_Validation(JFXTextField filed , int length){
 ...
 return true;
   ...
   public static boolean Min_Max_Length_Validation(JFXTextField field , int max , int min , String name){
       Alert a = new Alert(AlertType.WARNING);
      ...
      public static boolean product_Price_color( JFXTextField field, int length  , int max){
   ...
   public static boolean product_price_dialog( JFXTextField field, int length , int max ,String msg){
   ...
   public  static void capitalizeString(JFXTextField field) {
