...
public class saleReturnController implements Initializable {
    ...
    private void deletePurchaseItem(){
                ...
                String query = "update saleInvoiceDetail set status='true' where sr='"+sr+"'";
    ...
    private void displayInvoiceDetail(String invoice){
        ...
        String query = "select * from saleInvoiceDetail where status='false' and invoice_number='"+invoice+"'";
        try {
            Statement st = Connection_DB.db_Connection().createStatement();
    ...
    private void populating_invoices(String date) {
        ...
        try {
            ...
            while(rs.next()){
                ...
                String q  ="select * from saleInvoiceDetail where invoice_number='"+invocie+"' and status='false'";
